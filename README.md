...
Merhabalar ben Vegas 3 yıldır discord adlı platformda bot yapıyorum ve bunun dışında birçok dil biliyorum bunlardan bazıları Pascal, Basic, C, C#, C++, R, Moo, Java, JavaScript, Cobol, Perl, PHP, Python, Css, Ada, Fortran, Typescript, Go, Delphi ve Swift' tir.
